...
Creamos un mensaje que generalice una verificación de que una operación _X_ se corra en menos de _Y_ tiempo. Tanto la implementación original como la nuestra cumplían la función de un _cronometro_, pero la actual permite introducir tanto una operación cualquiera sobre el _customerBook_ como así tambien una cantidad de milisegundos.
...
Actualmente, para representar entidades de la realidad conocemos tanto a las clases (y sus subclases) como a los objetos. Con estos podemos modelar 1:1: entes de la realidad.
